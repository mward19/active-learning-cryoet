...
class SubtomogramPointDataset(Dataset):
    ...
    If class_probs is on, __getitem__ returns the probabilities of each class as
    a tensor. If class_probs is off, returns the list of points in the tile.
    """
    def __init__(self, base_dir, tiles_dir_name='tiling-5', class_probs=True, max_tiles=None):
    ...
    def __getitem__(self, idx):
        ...
        if self.class_probs:
            ...
            return tile, [int(not has_point), int(has_point)]
        else:
            return tile, points
...
def test_viz():
    ...
    spd = SubtomogramPointDataset(r'/home/mward19/nobackup/autodelete/fm-data-2', class_probs=False, max_tiles=1000)
...
def test_probs():
    """Debugging."""
    spd = SubtomogramPointDataset(r'/home/mward19/nobackup/autodelete/fm-data-2', class_probs=True, max_tiles=1000)
